...
public class activity_conductor_maps extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    public static final String LOG_TAG = activity_conductor_maps.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                Toast.makeText(activity_conductor_maps.this, "Request Available!", Toast.LENGTH_LONG).show();
                CharSequence name = getString(R.string.channel_name);
                String description = getString(R.string.channel_description);
                int importance = NotificationManager.IMPORTANCE_DEFAULT;

                NotificationCompat.Builder builder = new NotificationCompat.Builder(activity_conductor_maps.this, channelId);
                Intent notificationIntent = new Intent(activity_conductor_maps.this, activity_conductor_maps.class);
                notificationIntent.putExtra(getString(R.string.launched_via_notification), true);
                TaskStackBuilder stackBuilder = TaskStackBuilder.create(activity_conductor_maps.this);
                stackBuilder.addParentStack(activity_conductor_maps.this);
    ...
    private void selectDrawrItem(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.link_bus:
                AlertDialog.Builder metaDialog = new AlertDialog.Builder(activity_conductor_maps.this);
            ...
            case R.id.logout:
                ...
                Intent intent = new Intent(activity_conductor_maps.this, activity_login.class);
...
// position on right bottom
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.e(LOG_TAG, "La latitud y longitud son : " + latLng);
